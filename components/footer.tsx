...
const Footer = () => {
  return (
    <footer className="bg-[#fafafa] py-12 px-6 md:px-0 border-t">
      <div className="xl:w-4/5 2xl:w-[68%] mx-auto">
        ...
        <div className="flex flex-col md:flex-row justify-between gap-8">
          ...
          <div className="space-y-3">
            <Image
              ...
              width={120}
              height={30}
              className="w-32"  // Reduced from w-40
              alt="Company Logo"
            />
            <div className="space-y-1">
              <p className="text-gray-600 text-base">9508260355</p>
              <p className="text-gray-600 text-base">amitkumar9304730@gmail.com</p>
            </div>
          </div>
        ...
        <div className="mt-10 flex flex-col md:flex-row justify-between items-center gap-4 border-t pt-6">
          <div className="flex space-x-4">
            <a href="https://www.instagram.com/skylene_official?igsh=bzhqaWhhb2psZHRj" target="_blank" rel="noopener noreferrer" className="text-gray-500 hover:text-gray-700">
            ...
            <a href="https://www.facebook.com/share/1FGMhqeT7c/" target="_blank" rel="noopener noreferrer" className="text-gray-500 hover:text-gray-700">
              <span className="sr-only">Facebook</span>
              <svg className="h-5 w-5" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
                <path fillRule="evenodd" d="M22 12c0-5.523-4.477-10-10-10S2 6.477 2 12c0 4.991 3.657 9.128 8.438 9.878v-6.987h-2.54V12h2.54V9.797c0-2.506 1.492-3.89 3.777-3.89 1.094 0 2.238.195 2.238.195v2.46h-1.26c-1.243 0-1.63.771-1.63 1.562V12h2.773l-.443 2.89h-2.33v6.988C18.343 21.128 22 16.991 22 12z" clipRule="evenodd" />
              </svg>
            </a>
            <a href="https://www.linkedin.com/in/amit-kumar-rayhw?utm_source=share&utm_campaign=share_via&utm_content=profile&utm_medium=android_app" target="_blank" rel="noopener noreferrer" className="text-gray-500 hover:text-gray-700">
          ...
          <div className="flex flex-col md:flex-row items-center gap-3 text-xs text-gray-500">
            <p>© {new Date().getFullYear()} Bird. All Rights Reserved.</p>
            <div className="flex gap-3">
              <Link href="/privacy" className="hover:text-gray-900">Privacy Policy</Link>
              <Link href="/terms" className="hover:text-gray-900">Terms of Service</Link>
              <Link href="/cookies" className="hover:text-gray-900">Cookie Settings</Link>
            </div>
          </div>
        </div>
      </div>
